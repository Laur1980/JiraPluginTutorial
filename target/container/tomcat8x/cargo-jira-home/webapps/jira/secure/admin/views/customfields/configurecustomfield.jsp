            ...
            <ww:if test="./basicMode == true">
                ...
                <tr>
                    ...
                    <td class="fieldValueArea" id="customfield_<ww:property value="/customFieldId"/>-value-<ww:property value="objectKey"/>">
                        ...
                        <ww:if test="/defaultValueAllowed == false">
                            <ww:text name="'admin.issuefields.customfields.config.default.value.notsupported'"></ww:text>
                        </ww:if>
                        <ww:elseIf test="baseEditUrl && /fieldLocked == false"><a id="customfield_<ww:property value="/customFieldId"/>-edit-<ww:property value="objectKey"/>" class="actionLinks subText" title="<ww:text name="'admin.issuefields.customfields.edit'">
