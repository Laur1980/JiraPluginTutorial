...
define('jira/jql/jql-grammar', function () {
    ...
    /** @type {JqlObject[]} */
    grammar.jql_was_predicates = [{ value: "AFTER", displayName: "AFTER", type: "java.util.Date", supportsList: "false" }, { value: "BEFORE", displayName: "BEFORE", type: "java.util.Date", supportsList: "false" }, { value: "BY", displayName: "BY", type: "com.atlassian.crowd.embedded.api.User", supportsList: "false", auto: "true" }, { value: "DURING", displayName: "DURING", type: "java.util.Date", supportsList: "true" }, { value: "ON", displayName: "ON", type: "java.util.Date", supportsList: "false" }];
    /** @type {JqlObject[]} */
...
define('jira/jql/util', ['jira/jql/jql-grammar', 'wrm/data'], function (grammar, wrmData) {
    ...
    JQLAutoCompleteUtil.getRecentFields = function () {
        if (JQLAutoCompleteUtil.recentValues == null) {
            JQLAutoCompleteUtil.recentValues = wrmData.claim('jira.webresources:jqlautocomplete.jql.autocomplete.recentFields');
        }
